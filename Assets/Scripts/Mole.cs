...
public class Mole : MonoBehaviour {
  ...
  private GameObject MoleHandler;

  void Start()
  {

    MoleHandler =  GameObject.FindWithTag("MoleHandler");
  ...
  private IEnumerator ShowHide(Vector2 start, Vector2 end) {
    ...
    if (hittable) {
      ...
      MoleHandler.GetComponent<MoleHandler>().Missed(moleIndex, moleType != MoleType.Bomb);
    }
  }
    ...
    if (hittable) {
      switch (moleType) {
        case MoleType.Standard:
          ...
          MoleHandler.GetComponent<MoleHandler>().AddScore(moleIndex);
          // Stop the animation
          StopAllCoroutines();
        ...
        case MoleType.Bomb:
          ...
          MoleHandler.GetComponent<MoleHandler>().GameOver(1);
          break;
        default:
          break;
      }
